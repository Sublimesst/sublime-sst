...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-7 right-7 z-50 flex items-center gap-2.5 bg-[#25D366] text-white rounded-full px-4 py-3 shadow-lg hover:-translate-y-0.5 transition-all duration-200"
